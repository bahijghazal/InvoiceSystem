...
namespace InvoiceSystem.Migrations
{
    ...
    [Migration("20251129185618_AddCustomerTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoiceSystem.Models.InvoiceDetail", b =>
                {
            ...
            modelBuilder.Entity("InvoiceSystem.Models.InvoiceHeader", b =>
                {
                    b.Property<int>("InvoiceHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvoiceSystem.Models.Item", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvoiceSystem.Models.InvoiceDetail", b =>
                {
                    b.HasOne("InvoiceSystem.Models.InvoiceHeader", "InvoiceHeader")
                        .WithMany("InvoiceDetails")
                        .HasForeignKey("InvoiceHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InvoiceSystem.Models.Item", "Item")
                        .WithMany("InvoiceDetails")
